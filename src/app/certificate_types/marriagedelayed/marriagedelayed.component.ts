...
@Component({
  selector: 'app-marriagedelayed.component',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './marriagedelayed.component.html',
  styleUrl: './marriagedelayed.component.css',
})
export class MarriagedelayedComponent {
